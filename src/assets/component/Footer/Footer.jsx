...
export default function Footer() {
    return (
        <>
            <div className="w-full h-[350px] m-auto bg-gradient-to-br from-blue-600 via-purple-500 to-blue-300 shadow-md">
                ...
                <div className="w-full flex bg-gradient-to-br from-blue-600 to-blue-400/80 border-t-2 border-blue-700/70">
                    <div className="w-full h-full flex justify-center px-20 max-w-screen-2xl m-auto">
                        <p className="font-bold text-blue-300">© 2025. RENTER 2025</p>
                    </div>
                </div>
            </div>
        </>
